"""
EcoSense AI - Timeline Component for Recent Activity
"""
...
def render_activity_timeline(activity_items: list):
    ...
    for item in activity_items:
        ...
        timeline_html += f"""
        <div style="display: flex; align-items: center; justify-content: space-between; padding: 0.85rem 1rem; background: rgba(248, 250, 252, 0.7); border: 1px solid #E2E8F0; border-radius: 12px;">
